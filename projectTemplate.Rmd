...
further, and possibly brake those categories down to other categories.
...
There doesn't seem to be a noticeble difference among days of week.
...
The differences among different districts are noticeble, there is
...
To answer the question regarding the trend, I will count all crimes for each
month.
...
How about hourly trends? I suspect there should be a lot of variability among hours. I will average over all days like in the previous plot, but I show only the average line.
...
summary(droplevels(crimes[Theft,]$Descript))
```

So we have entries like "Grand Theft from Locked Auto". Most entries seem to be theft of items, but there are also entries containing theft of property, or services.

For a complete picture, the data needs to be cleaned a little. I'll have a
look at the categories Vehicle Theft, Burglary, Robbery, Fraud, Secondary
Codes, Stolen Property, Embezzlement, Bad Checks and Extortion. I will
try to include all in two main theft categories: Phisical/Forced, and
Information/Property/Fraud.
